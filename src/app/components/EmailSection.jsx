  ...
  return (
    ...
    >
      ...
      <div className="z-10">
        ...
        <p className="font-abc text-[#ADB7BE] mb-4 max-w-md">
          {" "}
        ...
        <div className="socials flex flex-row gap-2">
          <Link href="https://github.com/KhoaPhamzzz" target="_blank">
            <Image src={GithubIcon} alt="Github Icon" />
          </Link>
          <Link href="https://www.linkedin.com/in/khoa-anh-pham/" target="_blank">
      ...
      <div>
        {emailSubmitted ? (
          ...
          <form className="flex flex-col" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="bg-color-transition hover:bg-primary-100 text-white font-medium py-1 px-1 rounded-lg w-full"
            >
              <span className=" hover:bg-slate-800 rounded-lg w-full px-1 py-1 inline-block">Hire Me</span>
            </button>
          </form>
        )}
      </div>
